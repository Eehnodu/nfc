  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">근태 내역 관리</h1>
          <p className="text-sm md:text-base text-gray-600">직원들의 출퇴근 기록을 조회하고 관리하세요</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex flex-col sm:flex-row justify-end mt-4 space-y-2 sm:space-y-0 sm:space-x-2">
            <Button
              variant="outline"
              onClick={() => setFilters({ department: "", employee: "", status: "", dateFrom: "", dateTo: "" })}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base md:text-lg">근태 기록</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="min-w-[80px]">직원명</TableHead>
                  <TableHead className="min-w-[80px]">부서</TableHead>
                  <TableHead className="min-w-[100px]">날짜</TableHead>
                  <TableHead className="min-w-[80px]">출근시간</TableHead>
                  <TableHead className="min-w-[80px]">퇴근시간</TableHead>
                  <TableHead className="min-w-[100px]">근무시간</TableHead>
                  <TableHead className="min-w-[80px]">초과근무</TableHead>
                  <TableHead className="min-w-[80px]">상태</TableHead>
                  <TableHead className="min-w-[80px]">작업</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {records.map((record) => (
