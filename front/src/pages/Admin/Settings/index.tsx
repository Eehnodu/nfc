  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">시스템 설정</h1>
          <p className="text-sm md:text-base text-gray-600">근태 관리 시스템의 정책과 설정을 관리하세요</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-600">출근 시간 이후 몇 분까지 지각으로 처리할지 설정</p>
            </div>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label>실시간 알림</Label>
                <p className="text-sm text-gray-600">출퇴근 시 실시간 알림 받기</p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-600">설정된 시간에 자동으로 퇴근 처리</p>
              </div>
              <Switch
                checked={settings.enableAutoCheckout}
                onCheckedChange={(checked) => handleInputChange("enableAutoCheckout", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-600">모든 출퇴근에 NFC 태그 필수</p>
              </div>
              <Switch
                checked={settings.requireNfcForAll}
                onCheckedChange={(checked) => handleInputChange("requireNfcForAll", checked)}
              />
            </div>
          </CardContent>
        </Card>
