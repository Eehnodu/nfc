      ...
      <header className="border-b bg-white shadow-sm">
        <div className="container mx-auto px-4 py-3 md:py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center space-x-2 text-sm md:text-base">
              <ArrowLeft className="w-4 h-4" />
              <span>메인으로 돌아가기</span>
            </Link>
            <Link to="/" className="flex items-center space-x-2">
              <div className="w-6 h-6 md:w-8 md:h-8 bg-primary rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xs md:text-sm">NFC</span>
              </div>
              <span className="text-lg md:text-xl font-bold text-gray-900 hidden sm:block">근태관리 시스템</span>
            </Link>
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md mx-auto">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription className="text-sm md:text-base">직원 또는 관리자 계정으로 로그인하세요</CardDescription>
          </CardHeader>
